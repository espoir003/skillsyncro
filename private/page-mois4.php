...
<head>
  ...
  <title>SkillSyncro - Le mois - quatrieme trimestre</title>
  <!-- General CSS Files -->
      ...
      element.addEventListener('click', function(event) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            window.location.href = 'selectionner-une-semaine'; // Remplacez 'selectionner-une-semaine' par le chemin de votre page de sélection d'année
          }
        };
