...
if(!isset($_SESSION['semaine_id']) and !isset($_SESSION['mois_id']) and !isset($_SESSION['annee']) and !isset($_SESSION['employee_id']) and isset($_SESSION['jour_id'])){
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="agentForm" method="POST" action="" >
                    <h3>Côtation pour l'année <?php echo $_SESSION['annee'] . " Mois de ". $_SESSION['mois_id']; ?></h3>
                    <fieldset>
                        <div class="row">
                            <div class="col-sm-6">
...
function submitForm() {
    ...
    xhr.open("POST", "private/App/includes/cotation.php", true); // true pour une requête asynchrone
