                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="choix-mois/2024"  class="font-15 annee-link" style="color: black;">
                          <h5 class="font-12">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="choix-mois/2024" class="annee-link">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="choix-mois/2025"  class="font-15 annee-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner l'année
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="choix-mois/2025" class="annee-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="choix-mois/2026"  class="font-15 annee-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner l'année
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="choix-mois/2026" class="annee-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="choix-mois/2027"  class="font-15 annee-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner l'année
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="choix-mois/2027" class="annee-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
      ...
      element.addEventListener('click', function(event) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            window.location.href = 'choix-mois'; // Remplacez 'choix-mois' par le chemin de votre page de sélection d'année
          }
        };
