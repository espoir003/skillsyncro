                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                            <div class="card-content">
                                <a href="selectioner-une-annee/<?= $employe['id_agent'] ?>" title="Cliquez pour sélectionner une année" class="font-15 employee-link" style="color: black;">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                            <div class="position-relative">
                                <div class="banner-img mt-3">
                                    <a href="selectioner-une-annee/<?= $employe['id_agent'] ?>" class="employee-link">
      ...
      element.addEventListener('click', function(event) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            window.location.href = 'selectioner-une-annee'; // Remplacez 'selectioner-une-annee' par le chemin de votre page de sélection d'année
          }
        };
