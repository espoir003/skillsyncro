                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="stat-semestriel/Semaine1"  class="font-15 semaine-link" style="color: black;">
                          <h5 class="font-12">
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="stat-semestriel/Semaine1" class="semaine-link">
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="stat-semestriel/Semaine2"  class="font-15 semaine-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner la semaine
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="stat-semestriel/Semaine2" class="semaine-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="stat-semestriel/Semaine3"  class="font-15 semaine-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner la semaine
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="stat-semestriel/Semaine3" class="semaine-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
                ...
                <div class="card-statistic-4">
                  <div class="align-items-center justify-content-between">
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="stat-semestriel/Semaine4"  class="font-15 semaine-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner la semaine
                            </h5>
                            </a>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="stat-semestriel/Semaine4" class="semaine-link">
                            <img src="assets/img/years.png" alt="">
                          </a>
      ...
      element.addEventListener('click', function(event) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            window.location.href = 'stat-semestriel'; // Remplacez 'selectionner-une-semaine' par le chemin de votre page de sélection d'année
          }
        };
