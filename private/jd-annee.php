...
<head>
  ...
  <title>SkillSyncro - Année - jd</title>
  <!-- General CSS Files -->
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <a href="affichage-jd/2024"  class="font-15 annee-link" style="color: black;">
                          <h5 class="font-12">
                             Sélectionner l'année
                            </h5>
                            </a>
                          <h2 class="mb-3 font-18"><?php echo date('Y'); ?></h2>
                      ...
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
                          <a href="affichage-jd/2024" class="annee-link">
      ...
      element.addEventListener('click', function(event) {
        ...
        xhr.onreadystatechange = function() {
          if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            window.location.href = 'affichage-jd'; // Remplacez 'affichage-jd' par le chemin de votre page de sélection d'année
          }
        };
