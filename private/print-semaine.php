...
if(!isset($_SESSION['semaine_id']) and !isset($_SESSION['annee']) and !isset($_SESSION['mois_id']) and !isset($_SESSION['employee_id'])){
                    ...
                    <div class="section-body">
                        ...
                        <div class="invoice">
                            ...
                            <div class="invoice-title" style="text-align: center;">
                                Rapport pour la <?php echo $_SESSION['semaine_id'] ?> Mois de <?php echo $_SESSION['mois_id'] ?> Année <?php echo $_SESSION['annee'] ?><hr>
                            </div>
                            ...
                            <table class="invoice-table">
                                ...
                                <tbody>
                                   ...
                                   // Obtention du mois actuel en français
                                    ...
                                    $sql = "SELECT c.agent, c.jour, c.mois, c.annee, c.realiser, c.semaine,c.heure_debut,c.heure_fin,c.commentaire,c.date, SUM(c.cotation) AS total_cotation, 
                                            ...
                                            GROUP BY c.agent, c.jour, c.mois, c.annee, c.realiser, c.semaine,c.heure_debut,c.heure_fin,c.commentaire,c.date, t.tache, t.pourcentage";
                                    ...
                                    foreach ($resultats as $key => $resultat) {
                                        ...
                                        if ($resultat['jour'] != $currentWeek) {
                                            // Si oui, affichage de la ligne fusionnée pour la nouvelle semaine
                                            echo "<tr style='background-color: #f2f2f2;'>";
                                            echo "<td colspan='9' style='text-align:center;'>" . $resultat['jour'] . "</td>";
                                            echo "</tr>";

                                            // Mise à jour de la semaine actuelle
                                            $currentWeek = $resultat['jour'];
                                        }
                                    ...
                                    if (isset($somme) && isset($point_avoir) && isset($pc) && !empty($somme) && !empty($point_avoir) && !empty($pc)) {
                                        ...
                                        if ($point_avoir != 0) {
                                            ...
                                            echo "<strong style='text-align:center;color:red;'>Pas des informations trouvées pour la " . $_SESSION['semaine_id'] . ' Mois ' . $_SESSION['mois_id'] . ' Année ' . $_SESSION['annee'] .'</strong>';
                                        }
                                    } else {
                                        echo "<strong style='text-align:center;color:red;'>Pas des informations trouvées pour la " . $_SESSION['semaine_id'] . ' Mois ' . $_SESSION['mois_id'] . ' Année ' . $_SESSION['annee'] .'</strong>';
                                    }
